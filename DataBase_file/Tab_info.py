...
class Informacje_o_tabelach:
    ...
    def Show_Klienci(self):
        ...
        self.table_frame.pack(expand=False, fill=tk.BOTH)
        ...
        self.tree.column("2", width=80, minwidth=80, stretch=True,anchor=tk.CENTER)
        self.tree.column("3", width=80, minwidth=80, stretch=True,anchor=tk.CENTER)
        self.tree.column("4", width=230, minwidth=230, stretch=True,anchor=tk.CENTER)
        self.tree.column("5", width=100, minwidth=100, stretch=True,anchor=tk.CENTER)
        self.tree.column("6", width=210, minwidth=210, stretch=True,anchor=tk.CENTER)
    ...
    def Show_Oferty(self):
        ...
        self.tree.column("5", width=360, minwidth=360, stretch=True, anchor=tk.CENTER)
        self.tree.heading("#0", text="", anchor=tk.CENTER)
    ...
    def Show_Posrednicy(self):
        ...
        self.tree.column("3", width=100, minwidth=100, stretch=True, anchor=tk.CENTER)
        self.tree.column("4", width=100, minwidth=100, stretch=True, anchor=tk.CENTER)
        self.tree.column("5", width=200, minwidth=200, stretch=True, anchor=tk.CENTER)
        self.tree.column("6", width=160, minwidth=160, stretch=True, anchor=tk.CENTER)
        self.tree.heading("#0", text="", anchor=tk.CENTER)
        ...
        self.tree.heading("6", text="", anchor=tk.CENTER)
    ...
    def Show_Typ_nieruchomosci(self):
        ...
        self.tree.column("3", width=300, minwidth=300, stretch=True, anchor=tk.CENTER)
    ...
    def Show_Umowy(self):
        ...
        self.tree.column("4", width=100, minwidth=100, stretch=True,anchor=tk.CENTER)
        self.tree.column("5", width=100, minwidth=100, stretch=True,anchor=tk.CENTER)
        self.tree.column("6", width=260, minwidth=260, stretch=True,anchor=tk.CENTER)
        self.tree.heading("#0", text="", anchor=tk.CENTER)
